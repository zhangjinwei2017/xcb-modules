...
/* FIXME */
static char *app = "csi300";
static char *desc = "CSI300 Index";
static char *fmt = "CSI300,timestamp,csi300";
...
MODULE_INFO(load_module, unload_module, reload_module, "CSI300 Index Application");
