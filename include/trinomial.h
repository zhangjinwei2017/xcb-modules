...
extern double tri_euro_put (double spot, double strike, double r, double d, double vol,
		double expiry, int steps);
extern double tri_amer_call(double spot, double strike, double r, double d, double vol,
		double expiry, int steps);
extern double tri_amer_put (double spot, double strike, double r, double d, double vol,
		double expiry, int steps);
extern void   tri_amer_call_greeks(double spot, double strike, double r, double d, double vol, double expiry,
